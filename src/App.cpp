...
#include "Summary.h"
#include "version.h"
#include "tui/C64MinerTui.h"
#include <thread>
#include <fcntl.h>
#include <unistd.h>

static std::atomic<bool> tui_stop{false};
...
int xmrig::App::exec()
{
    ...
    // C64 Miner: Play Datasette animation
    c64tui::play_datasette_animation();

    // Redirect stdout/stderr (TUI uses /dev/tty)
